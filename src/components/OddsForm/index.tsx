...
const OddsForm = ({ setShowForm }: OddsFormProps) => {
  ...
  useEffect(() => {
    bookieNames.forEach((bookieName) => {
      setFieldValue(`odds.${bookieName}.suspended`, values.suspendAll ? true : false);
    });
  }, [values.suspendAll]);
    ...
    <div className="form-container">
      ...
      <div className="delete-section">
        <div className="suspend-toggle">
          ...
          <ToggleSwitch id="suspendAll" name="suspendAll" checked={values.suspendAll} onChange={handleChange} />
        </div>
