...
const FooterForm = (props: any) => {
              ...
              links: ensureArrayLength(
                response.data.followUs.map((item: any) => {
                  return {
                    name: item?.link,
                    icon: null,
                    preview: item?.icon?.imageUrl || null,
                  };
                }),
                { name: "", icon: null, preview: null },
                5
  ...
  const handleAddAccordianSection = () => {
    setFieldValue("accordianSections", [
      ...values.accordianSections,
      { title: "", expandedText: "" },
    ]);
  };
      ...
      <div className="wrapper">
        <div className="form-header">
          <h1 className="form-heading">
            {formId ? "Update Footer Data" : "All Footer"}
          </h1>
      ...
      <div className="form-container">
        <>
            ...
            (
              {
                ...
                icon,
                preview,
              }: { name: string; icon: any; preview: string },
              index: any
            ) => (
                  ...
                  <>
                    <div className="group__input1">
                      ...
                      <input
                        type="text"
                        onChange={handleChange}
                        id={`pageLinks.${index}].name`}
                        name={`pageLinks.${index}.name`}
                        value={values.pageLinks[index].name}
                      />
                    </div>
                    <div className="group__input1">
                      ...
                      <input
                        type="text"
                        onChange={handleChange}
                        id={`pageLinks.${index}].link`}
                        name={`pageLinks.${index}.link`}
                        value={values.pageLinks[index].link}
                      />
                    </div>
                  </>
                ))}
          ...
          <div>
              ...
              <>
                <div className="accordian">
                  ...
                  {index != 0 && (
                    <div
                      className="delete"
                      onClick={() => handleDeleteAccordianSection(index)}
                    >
            ...
            <div
              className="add-new-section-label"
              onClick={handleAddAccordianSection}
            >
            ...
            <>
              <div className="other-text">
                ...
                <input
                  type="text"
                  onChange={handleChange}
                  id={`otherSections.${index}.title`}
                  name={`otherSections.${index}.title`}
                  value={values.otherSections[index].title}
                />
                <div className="logo-icon">
                  <label>Icon:</label>
                  <ImageUploader
                ...
                <div
                  className="delete"
                  onClick={() => handleDeleteNewTextSection(index)}
                >
                  <div className="delete-icon">
                    <svg viewBox="0 0 24 24">
                      <path d="M6,19C6,20.1 6.9,21 8,21H16C17.1,21 18,20.1 18,19V7H6V19M8.46,11.88L9.87,10.47L12,12.59L14.12,10.47L15.53,11.88L13.41,14L15.53,16.12L14.12,17.53L12,15.41L9.88,17.53L8.47,16.12L10.59,14L8.46,11.88M15.5,4L14.5,3H9.5L8.5,4H5V6H19V4H15.5Z"></path>
          ...
          <div
            className="add-new-section-label"
            onClick={(e: any) => handleAddNewTextSection()}
          >
            <img src="/images/plus.png" alt="" />
          ...
          >
            {!loading ? (
              ...
              <img className="save-loader" src="/images/loading.gif" alt="" />
            )}
          </button>
        </>
      </div>
