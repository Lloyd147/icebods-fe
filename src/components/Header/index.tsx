      ...
      <div className="wrapper">
        <div className="admin-nav-content">
          ...
          <div className="nav-links">
            {token ? (
              <>
                <Link href="/admin/portables" className={pathname === '/admin/portables' ? 'link-item --active' : 'link-item'}>
                  Basic
                </Link>
                <Link href="/admin/barrels" className={pathname === '/admin/barrels' ? 'link-item --active' : 'link-item'}>
                  Mid-tier
                </Link>
                <Link href="/admin/tubs" className={pathname === '/admin/tubs' ? 'link-item --active' : 'link-item'}>
                  Luxury
                </Link>
